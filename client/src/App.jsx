  ...
  return (
    <>
      <main className='min-h-screen w-[100vw] overflow-y-auto bg-transparent font-poppins flex flex-col items-center justify-center'>
        ...
        <article className='grid p-8 grid-cols-1 lg:grid-cols-3 lg:grid-rows-3 gap-6 lg:w-[1000px] border border-red'>
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[4px] border-red lg:col-start-2 lg:row-start-1'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[4px] border-cyan lg:col-start-1 lg:row-start-2'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[4px] border-orange lg:col-start-2 lg:row-start-3'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[4px] border-blue lg:col-start-3 lg:row-start-2'>
