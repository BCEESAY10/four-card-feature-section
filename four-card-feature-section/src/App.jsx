    ...
    <>
      <main className='min-h-full min-w-[375px] lg:w-[1440px] bg-transparent p-6 lg:p-16 font-poppins flex flex-col items-center justify-center'>
        ...
        <article className='grid px-8 gap-6 mt-10 grid-cols-1 lg:grid-cols-3 lg:grid-rows-3 lg:w-[900px]'>
          <div className='w-[90%] lg:w-46 h-42 lg:h-36 relative bg-white p-6 rounded-lg shadow-lg border-t-[6px] border-red lg:row-start-1 lg:col-start-2'>
          ...
          <div className='w-[90%] lg:w-46 h-42 lg:h-36 relative bg-white p-6 rounded-lg shadow-lg border-t-[6px] border-cyan lg:row-start-2'>
          ...
          <div className='w-[90%] lg:w-46 h-42 lg:h-36 relative bg-white p-6 rounded-lg shadow-lg border-t-[6px] border-orange lg:row-start-2 lg:col-start-2'>
          ...
          <div className='w-[90%] lg:w-46 h-42 lg:h-36 relative bg-white p-6 rounded-lg shadow-lg border-t-[6px] border-blue lg:row-start-2 lg:col-start-3'>
