...
function App(){
  ...
  return (
    <>
      <main className='min-h-full min-w-[375px] lg:w-[1440px] overflow-y-auto bg-transparent p-6 lg:p-16 font-poppins flex flex-col items-center justify-center'>
        <header className='w-full lg:w-[500px] text-center px-8 space-y-8'>
        ...
        <article className='grid px-8 gap-6 mt-10 grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 lg:w-[900px]'>
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[6px] border-red lg:row-start-1 lg:col-start-2'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[6px] border-cyan lg:row-start-2 lg:col-start-1'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[6px] border-orange lg:row-start-2 lg:col-start-2'>
          ...
          <div className='w-[300px] min-h-[200px] relative bg-white p-6 rounded-lg shadow-md border-t-[6px] border-blue lg:row-start-2 lg:col-start-3'>
